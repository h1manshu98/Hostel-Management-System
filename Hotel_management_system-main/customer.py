...
class Cust_Win:
    def __init__(self,root):
        ...
        ################ Title ##################
        lbl_title = Label(self.root,text="ADD STUDENT DETAILS",font=("times new roman",18,"bold"),bg="blue",fg="white",bd=4,relief=RIDGE)
        ...
        ################ LABEL FRAME ###################
        lblFrameLeft=LabelFrame(self.root,bd=2,relief=RIDGE,text="STUDENT DETAILS",font=("times new roman",12,"bold"),padx=2)
        lblFrameLeft.place(x=5,y=40,width=425,height=410)

        ############### LABELS & ENTRIES ##############

        ############## REFRENCE NO. #################
        lbl_cust_ref = Label(lblFrameLeft,text="STUDENT REF :",font=("arial",10,"bold"),padx=2,pady=6)
        lbl_cust_ref.grid(row=0,column=0,sticky=W)
        
        entry_ref = ttk.Entry(lblFrameLeft,textvariable=self.var_ref,width=29,font=("arial",11,"bold"),state=DISABLED)
        entry_ref.grid(row=0,column=1)

        ############## STUDENT NAME ##############
        lbl_cust_name = Label(lblFrameLeft,text="STUDENT NAME :",font=("arial",10,"bold"),padx=2,pady=6)
        ...
        btn_reset = Button(btn_frame,text="RESET",command=self.data_reset,font=("arial",10,"bold"),bg="blue",fg="white",width=10)
    ...
    def dat_Delete(self):
        ...
        if dat_Delete>0:
            ...
            # messagebox.showinfo("Update","Customer details has been deleted sucessfully",parent=self.root)
        else:
            if not dat_Delete:
                return
        conn.commit()
