...
class Roombooking:
    def __init__(self,root):
        ...
        ############## CUSTOMER CONTACT. #################
        lbl_cust_contact= Label(lblFrameLeft,text="STUDENT CONTACT :",font=("arial",10,"bold"),padx=2,pady=6)
        ...
        ############# FEATCH DATA BUTTON ##########
        btn_featch_data = Button(lblFrameLeft,command=self.fetch_contact,text="FETCH DATA",font=("arial",8,"bold"),bg="blue",fg="white",width=10)
        ...
        conn = mysql.connector.connect(host="localhost",username="root",password=" ",database="ankur")
        my_cursor = conn.cursor()
        my_cursor.execute("Select ROOM_TYPE from room")
        ...
        #txtroom_available=ttk.Entry(lblFrameLeft,textvariable=self.var_room_available,width=29,font=("arial",11,"bold"))
        ...
        txtid_number = ttk.Entry(lblFrameLeft,textvariable=self.var_total,width=29,font=("arial",11,"bold"))
        txtid_number.grid(row=9,column=1)

        ############# BILL BUTTON ##########
        btn_bill_button = Button(lblFrameLeft,text="BILL",command=self.total,font=("arial",10,"bold"),bg="blue",fg="white",width=10)
    ...
    def update(self):
        if self.var_contact.get()=="":
            ...
            conn = mysql.connector.connect(password=" ",database="ankur")
            my_cursor = conn.cursor()
    ...
    def total(self):
        ...
        if (self.var_room_type.get()=="THREE BED"):
            q1 = float(300)
            q2 = float(700)
        ...
        elif (self.var_room_type.get()=="SINGLE BED"):
            q1 = float(300)
            q2 = float(700)
            q3 = float(self.var_no_of_days.get())
            q4 = float(q1+q2)
        ...
        elif (self.var_room_type.get()=="DOUBLE BED"):
            q1 = float(500)
            q2 = float(1000)
            q3 = float(self.var_no_of_days.get())
            q4 = float(q1+q2)
